...
const shortlistedTeams: ShortlistedTeam[] = [
  ...
  { teamName: 'ROAD_BREEZE', leader: 'Prajwal Maths', domain: 'HARDWARE', status: 'SHORTLISTED' },
  ...
  { teamName: 'AlgoRiders', leader: 'Sufiyan Saleem ahmed', domain: 'SOFTWARE', status: 'SHORTLISTED' },
